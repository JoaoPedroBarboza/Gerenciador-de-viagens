...
import { ConfirmeTripModal } from "./confirm-trip-modal";
...
export function CreateTripPage() {
  ...
  const [emailsToEnvite, setEmailsToInvite] = useState([
    "João@gmail.com"
  ])
  ...
  function removeEmailFromInvites(emailToRemove: string) {
    const newEmailList = emailsToEnvite.filter(email => email !== emailToRemove)
